...
{
	public class UnpauseTournamentEvaluationCommandHandlerTest : TournamentCommandHandlerTestBase
	{
		/// <inheritdoc />
		public UnpauseTournamentEvaluationCommandHandlerTest(ITestOutputHelper output) :
			base(output)
		{
		}
