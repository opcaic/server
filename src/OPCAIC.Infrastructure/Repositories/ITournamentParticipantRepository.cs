...
namespace OPCAIC.Infrastructure.Repositories
{
	...
	{
		Task<ListDto<TournamentParticipantDto>> GetParticipantsAsync(long tournamentId, TournamentParticipantFilterDto filter, CancellationToken cancellationToken = default);
