...
namespace OPCAIC.Persistence.Migrations
{
    ...
    [Migration("20191118192733_DeletableUser")]
    partial class DeletableUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OPCAIC.Domain.Entities.Match", b =>
                {
                    ...
                    b.Property<long?>("LastExecutionId")
                        .HasColumnType("bigint");

                    b.Property<long?>("LastExecutionId1")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("OPCAIC.Domain.Entities.Submission", b =>
                {
                    ...
                    b.Property<long?>("LastValidationId")
                        .HasColumnType("bigint");

                    b.Property<long?>("LastValidationId1")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("TournamentParticipationId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("LastValidationId1");

                    b.HasIndex("TournamentId");

                    b.HasIndex("TournamentParticipationId");
            ...
            modelBuilder.Entity("OPCAIC.Domain.Entities.Match", b =>
                {
                    b.HasOne("OPCAIC.Domain.Entities.MatchExecution", "LastExecution")
                        .WithMany()
                        .HasForeignKey("LastExecutionId1");
            ...
            modelBuilder.Entity("OPCAIC.Domain.Entities.Submission", b =>
                {
                    ...
                    b.HasOne("OPCAIC.Domain.Entities.SubmissionValidation", "LastValidation")
                        .WithMany()
                        .HasForeignKey("LastValidationId1");
                    ...
                    b.HasOne("OPCAIC.Domain.Entities.TournamentParticipation", "TournamentParticipation")
                        .WithMany("Submissions")
                        .HasForeignKey("TournamentParticipationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
