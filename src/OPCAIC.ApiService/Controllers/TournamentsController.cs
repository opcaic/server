...
namespace OPCAIC.ApiService.Controllers
{
	...
	public class TournamentsController : ControllerBase
	{
		...
		/// <summary>
		///     Gets detailed information about the tournament for administrators.
		/// </summary>
		/// <param name="id">Id of the tournament.</param>
		/// <param name="cancellationToken"></param>
		/// <returns></returns>
		...
		[ProducesResponseType(StatusCodes.Status403Forbidden)]
		[ProducesResponseType(StatusCodes.Status404NotFound)]
		public async Task<TournamentAdminDto> GetTournamentByIdForAdminAsync(long id,
			CancellationToken cancellationToken)
		{
			await authorizationService.CheckPermission(User, id, TournamentPermission.ReadAdmin);
			return await mediator.Send(new GetTournamentAdminQuery(id), cancellationToken);
		}
